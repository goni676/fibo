...
public class FibonacciHeap {
    ...
    public void deleteMin() {
        ...
        if (child != null) {
            ...
            do {
                HeapNode nSibling = sibling.next;
                removeNode(sibling);
                insertNode(sibling);
                sibling = nSibling;
...
//            return;
//        }
////      In the case of a single element in the heap, set its field to the default value
//        if (size == 1) {
//            head = null;
//            min = null;
//            size = 0;
...
//        HeapNode child = deleted.getChild();
//
////      create a root from each child of the minimum node and insert it into the heap
//        if (child != null) {
//            HeapNode sibling = child;
//            do {
//                HeapNode nSibling = sibling.next;
...
//        while (i > 0) {
//            int rank = node1.getRank();
////          look for two roots x and y with the same degree
//            while (arr[rank] != null) {
//                HeapNode node2 = arr[rank];
//                if (node1.getKey() > node2.getKey()) {
//                    HeapNode tmp = node1;
...
//
//                }
////          Connect two roots x and y with the same degree from the root list
//                link(node2, node1);
//                arr[rank] = null;
//                rank++;
//            }
